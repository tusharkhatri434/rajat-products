        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 items-start">
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:Rpalloys2000@gmail.com" className="text-primary hover:underline text-sm break-all">Rpalloys2000@gmail.com</a>
                    </div>
                  </div>
              ...
              <div className="bg-gradient-to-br from-primary to-[#1f5c7a] rounded-2xl shadow-lg p-6 md:p-8 text-white">
