        ...
        <div className="opacity-0 animate-fade-in-up">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 opacity-0 animate-fade-in animation-delay-300">
            ...
            <div className="flex flex-wrap gap-4 justify-center text-sm">
              <Link to="/about" className="text-teal-600 hover:text-teal-700 font-medium transition-colors duration-200">
                About Us
              </Link>
              <span className="text-gray-400">•</span>
              <Link to="/infrastructure" className="text-teal-600 hover:text-teal-700 font-medium transition-colors duration-200">
                Infrastructure
              </Link>
              <span className="text-gray-400">•</span>
              <Link to="/certifications" className="text-teal-600 hover:text-teal-700 font-medium transition-colors duration-200">
                Certifications
              </Link>
            </div>
          </div>
