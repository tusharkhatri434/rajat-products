      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="opacity-0 animate-fade-in-up">
          ...
          <div className="mb-8 opacity-0 animate-fade-in-up animation-delay-100">
            <div className="text-9xl font-bold text-[#2C7596] mb-4">404</div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200 opacity-0 animate-fade-in animation-delay-300">
            ...
            <div className="flex flex-wrap gap-4 justify-center text-sm">
              <Link to="/about" className="text-[#2C7596] hover:text-[#1f5c7a] font-medium transition-colors duration-200">
                About Us
              </Link>
              <span className="text-gray-400">•</span>
              <Link to="/infrastructure" className="text-[#2C7596] hover:text-[#1f5c7a] font-medium transition-colors duration-200">
                Infrastructure
              </Link>
              <span className="text-gray-400">•</span>
              <Link to="/certifications" className="text-[#2C7596] hover:text-[#1f5c7a] font-medium transition-colors duration-200">
                Certifications
              </Link>
            </div>
          </div>
