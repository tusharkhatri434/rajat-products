  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <h3 className="text-base md:text-lg font-bold text-gray-900 mb-2 md:mb-3 group-hover:text-[#2C7596] transition-colors duration-300">
          {subProduct.name}
        </h3>
        ...
        <button className="text-[#2C7596] text-xs md:text-sm font-medium hover:text-[#1f5c7a] transition-colors duration-200 hover:underline">
          View Specifications →
        </button>
      </div>
